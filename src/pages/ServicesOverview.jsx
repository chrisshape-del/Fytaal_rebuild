    ...
    return (
        <div className="pt-20 bg-neutral-50 min-h-screen">
            ...
            <section className="py-20 px-4 text-center relative overflow-hidden">
                ...
                >
                    Of je nu wilt revalideren, presteren of gewoon lekker wilt bewegen.
                    Wij hebben de expertise en de faciliteiten om jou te helpen.
                </motion.p>
            </section>
            ...
            <section className="px-4 pb-32 max-w-7xl mx-auto">
                ...
                <div className="mt-16 bg-slate-900 rounded-3xl p-12 text-center text-white relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-3xl font-heading font-bold mb-4">Bekijk het Rooster</h2>
                        <p className="text-slate-400 mb-8 max-w-xl mx-auto">
                            Benieuwd wanneer je favoriete training plaatsvindt? Bekijk ons actuele weekrooster.
                        </p>
                        <Link to="/rooster" className="inline-flex items-center gap-2 bg-white text-slate-900 px-8 py-4 rounded-full font-bold hover:bg-primary hover:text-white transition-all">
                            Naar het rooster <MoveRight className="w-4 h-4" />
                        </Link>
                    </div>
                </div>
            </section>
