...
// Full Rooster Data (restoring mock data)
const roosterEvents = [
    { day: 'Maandag', startTime: '07:00', endTime: '08:00', activity: 'Hyrox Foundation', type: 'hyrox', trainer: 'Koen', status: 'available' },
    { day: 'Maandag', startTime: '09:00', endTime: '10:00', activity: 'Vitaliteit Check-in', type: 'vitaliteit', trainer: 'Sarah', status: 'full' },
    { day: 'Maandag', startTime: '19:00', endTime: '20:00', activity: 'Kickstart Group A', type: 'kickstart', trainer: 'Marcus', status: 'available' },
    { day: 'Dinsdag', startTime: '08:00', endTime: '09:00', activity: '1-on-1 PT', type: 'pt', trainer: 'Koen', status: 'booked' },
    { day: 'Dinsdag', startTime: '18:30', endTime: '19:30', activity: 'Small Group Strength', type: 'pgt', trainer: 'Julian', status: 'available' },
    { day: 'Woensdag', startTime: '07:00', endTime: '08:00', activity: 'Hyrox WOD', type: 'hyrox', trainer: 'Koen', status: 'available' },
    { day: 'Woensdag', startTime: '10:00', endTime: '11:00', activity: 'Vitaliteit Coaching', type: 'vitaliteit', trainer: 'Sarah', status: 'available' },
    { day: 'Donderdag', startTime: '19:00', endTime: '20:00', activity: 'Small Group HIIT', type: 'pgt', trainer: 'Julian', status: 'last_spots' },
    { day: 'Donderdag', startTime: '20:00', endTime: '21:00', activity: 'Kickstart Group B', type: 'kickstart', trainer: 'Marcus', status: 'available' },
    { day: 'Vrijdag', startTime: '07:00', endTime: '08:00', activity: 'Hyrox Endurance', type: 'hyrox', trainer: 'Koen', status: 'available' },
    { day: 'Vrijdag', startTime: '11:00', endTime: '12:00', activity: '1-on-1 PT', type: 'pt', trainer: 'Sarah', status: 'available' },
    { day: 'Zaterdag', startTime: '09:00', endTime: '10:30', activity: 'Hyrox Simulation', type: 'hyrox', trainer: 'Koen', status: 'waitlist', isWeekend: true }
];

const roosterData = {
    hero: { title: "Rooster", subtitle: "Bekijk hier wanneer jouw favoriete trainingen zijn." },
    schedule_info: { title: "Openingstijden", description: "Wij zijn 7 dagen per week geopend." },
    events: roosterEvents
};
...
const contactData = {
    ...
    info: {
        ...
        phone: "06 20 63 68 08",
        address: "Amsterdamsestraatweg 21, 3744 MA Baarn"
    },
    reviews: [
        {
            name: 'Gerard Born',
...
const sqlStatements = [];
sqlStatements.push("DELETE FROM Content WHERE id IN ('rooster', 'aanbod', 'contact', 'reform');");

sqlStatements.push(`INSERT INTO Content (id, data) VALUES ('rooster', '${JSON.stringify(roosterData).replace(/'/g, "''")}');`);
sqlStatements.push(`INSERT INTO Content (id, data) VALUES ('aanbod', '${JSON.stringify(aanbodData).replace(/'/g, "''")}');`);
sqlStatements.push(`INSERT INTO Content (id, data) VALUES ('contact', '${JSON.stringify(contactData).replace(/'/g, "''")}');`);
sqlStatements.push(`INSERT INTO Content (id, data) VALUES ('reform', '${JSON.stringify(reformData).replace(/'/g, "''")}');`);


fs.writeFileSync('seed_full_fix.sql', sqlStatements.join('\n'));
console.log('Generated seed_full_fix.sql');
